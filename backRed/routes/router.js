...
exports.assignRoutes = function (app) {
    ...
    function saveInCassandra() {
        db.getFeaturedPost(3, (result) => {
            clientCassandra.removeandSaveCassandraPubs(result);
        })
    };

    setInterval(saveInCassandra, 60000);
    ...
    app.get('/trendingPublications', clientCassandra.getPublications);
    /*
